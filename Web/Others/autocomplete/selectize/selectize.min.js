  ...
  (Sifter.prototype.tokenize = function (query) {
    ...
    (Sifter.prototype.getScoreFunction = function (search, options) {
      function scoreValue(value, token) {
        var pos;
        return !value ||
          -1 === (pos = (value = String(value || "")).search(token.regex))
          ? 0
          : ((token = token.string.length / value.length),
            0 === pos && (token += 0.5),
            token);
      }
      var field_count,
    ...
    (Sifter.prototype.search = function (query, options) {
      ...
      return (
        ...
        (query = this.getSortFunction(search, options)) &&
          search.items.sort(query),
            ...
            e.type &&
              ...
              46 === keyCode || 8 === keyCode
                ? (selection = getSelection($input[0])).length
                  ? (options =
                      options.substring(0, selection.start) +
                      options.substring(selection.start + selection.length))
                  : 8 === keyCode && selection.start
                  ? (options =
                      options.substring(0, selection.start - 1) +
                      options.substring(selection.start + 1))
                  : 46 === keyCode &&
                ...
                : printable &&
                  ((keyCode = e.shiftKey),
                  (selection = String.fromCharCode(e.keyCode)),
                  (options += selection =
                    keyCode
                      ? selection.toUpperCase()
                      : selection.toLowerCase()))),
            (printable = $input.attr("placeholder")),
            (e = $input),
            (selection =
              ((keyCode = options = !options && printable ? printable : options)
                ? (Selectize.$testInput ||
                    ...
                    $("<div />")
                      ...
                      .appendTo("body")),
                  Selectize.$testInput.text(keyCode),
                  transferStyles(e, Selectize.$testInput, [
                    "letterSpacing",
                    "fontSize",
                    "fontFamily",
                    "fontWeight",
    ...
    return (
      ...
      $.extend(Selectize.prototype, {
        setup: function () {
          ...
          (inputId = $input.attr("id")) &&
            ...
            self.plugins.names.length &&
              ((inputId = "plugin-" + self.plugins.names.join(" plugin-")),
              $wrapper.addClass(inputId),
              inputMode.addClass(inputId)),
            ...
            !self.settings.splitOn &&
              ...
              ((classes = self.settings.delimiter.replace(
                /[-\/\\^$*+?.()|[\]{}]/g,
                "\\$&"
              )),
              (self.settings.splitOn = new RegExp("\\s*" + classes + "+\\s*"))),
              ...
              case 40:
                return (
                  !this.isOpen && this.hasOptions
                    ...
                    : this.$activeOption &&
                      ((this.ignoreHover = !0),
                      ($next = this.getAdjacentOption(this.$activeOption, 1))
                        .length && this.setActiveOption($next, !0, !0)),
              ...
              : void 0 !== ($target = $target.attr("data-value")) &&
                ...
                self.settings.closeAfterSelect
                  ...
                  : !self.settings.hideSelected &&
                    e.type &&
                    /mouse/.test(e.type) &&
                    self.setActiveOption(self.getOption($target)));
        },
            ...
            if (
              ...
              for (
                $last = this.$control.children(".active:last"),
                  $last = Array.prototype.indexOf.apply(
                  ...
                  (end = Array.prototype.indexOf.apply(
                    this.$control[0].childNodes,
                    [$item[0]]
                  )) < $last && ((swap = $last), ($last = end), (end = swap)),
                  i = $last;
                i <= end;
                i++
              )
              ...
              ("mousedown" === eventName && this.isCtrlDown) ||
              ("keydown" === eventName && this.isShiftDown)
                ? $item.hasClass("active")
                  ? ((swap = this.$activeItems.indexOf($item[0])),
                    this.$activeItems.splice(swap, 1),
                      ...
                      if (3 === node.nodeType) {
                        ...
                        0 <= pos &&
                          ...
                          ((spannode =
                            ...
                            "highlight"),
                          (pos = node.splitText(pos)).splitText(
                            match[0].length
                          ),
        ...
        updateOption: function (value, data) {
          ...
          if (
            ...
            (order_old = this.options[value].$order),
              ...
              index_item &&
                (delete index_item[value], delete index_item[value_new]),
              order_old &&
                (delete order_old[value], delete order_old[value_new]),
              -1 !== this.items.indexOf(value_new) &&
                ((index_item = this.getItem(value)),
                (order_old = $(this.render("item", data))),
                index_item.hasClass("active") && order_old.addClass("active"),
                index_item.replaceWith(order_old)),
              (this.lastQuery = null),
        ...
        getAdjacentOption: function ($option, direction) {
          ...
          return 0 <= $option && $option < $options.length
            ? $options.eq($option)
            : $();
        },
        ...
        addItems: function (values, silent) {
          ...
          values.insertBefore(this.buffer, values.firstChild),
            (this.buffer = null);
        },
              ...
              -1 === this.items.indexOf(value)
                ? this.options.hasOwnProperty(value) &&
                  ...
                  ("multi" === inputMode && this.isFull()) ||
                    ...
                    (this.isPending && (wasFull || !this.isFull())) ||
                      this.refreshState(),
                    this.isSetup &&
                      ((wasFull =
                        this.$dropdown_content.find("[data-selectable]")),
                      this.isPending ||
                        ...
                        ($option = this.getAdjacentOption($option, 1).attr(
                          "data-value"
                        )),
                        this.refreshOptions(
                        ...
                        $option &&
                          this.setActiveOption(this.getOption($option))),
                      !wasFull.length || this.isFull()
                        ? this.close()
              ...
              "function" == typeof self.settings.create
                ...
                : function (input) {
                    ...
                    if (
                      ...
                      (null ==
                        (input = self.settings.formatValueToKey.apply(this, [
                          input,
                        ])) ||
                        "object" == typeof input ||
        ...
        deleteSelection: function (e) {
          ...
          if (
            ...
            return !1;
          for (void 0 !== $tail && this.setCaret($tail); values.length; )
        ...
        advanceSelection: function (direction, e) {
          ...
          0 !== direction &&
            ...
            this.isFocused && !this.isInputHidden
              ...
              : (selection = this.$control.children(".active:" + tail))
                  .length &&
                ((valueLength = this.$control
                  .children(":not(input)")
                  .index(selection)),
                this.setActiveItem(null),
                this.setCaret(0 < direction ? valueLength + 1 : valueLength)));
        },
      ...
      ($.fn.selectize = function (settings_user) {
        function init_select($input, settings_element) {
          function addOption($option, group) {
            ...
            (value || settings.allowEmptyOption) &&
              (optionsMap.hasOwnProperty(value)
                ? group &&
                  ((arr = optionsMap[value][field_optgroup])
                    ? $.isArray(arr)
                      ? arr.push(group)
                      : (optionsMap[value][field_optgroup] = [arr, group])
                    : (optionsMap[value][field_optgroup] = group))
                : (((arr = readData($option) || {})[field_label] =
                    arr[field_label] || $option.text()),
                  (arr[field_value] = arr[field_value] || value),
                  (arr[field_disabled] =
                    arr[field_disabled] || $option.prop("disabled")),
          ...
          var i,
            ...
            readData = function ($el) {
              ...
              return "string" == typeof $el && $el.length
                ? JSON.parse($el)
                : null;
            };
          for (
        ...
        return this.each(function () {
          ...
          this.selectize ||
              ...
              : function ($input, settings_element) {
                  ...
                  if (data_raw)
                    ...
                    if (settings.allowEmptyOption || data_raw.length) {
                      for (
                        i = 0,
                          n = (values = data_raw.split(settings.delimiter))
                            .length;
                        i < n;
                        i++
                      )
            ...
            new Selectize(
              $input,
              $.extend(!0, {}, defaults, input_html, settings_user)
            ));
        });
      }),
        ...
        function equalizeSizes() {
          ...
          if (n && self.$dropdown_content.width()) {
            ...
            options.equalizeWidth &&
              ...
              1 < n &&
                ((width_parent = width_parent - width * (n - 1)),
                $optgroups.eq(n - 1).css({ width: width_parent })));
          }
        }
        var original,
          self = this,
                ...
                return !this.isOpen || (37 !== e.keyCode && 39 !== e.keyCode)
                  ...
                  : ((self.ignoreHover = !0),
                    ...
                    void (
                      ($optgroup = (e = ($optgroup =
                        37 === e.keyCode
                          ? $optgroup.prev("[data-group]")
                          : $optgroup.next("[data-group]")).find(
                        "[data-selectable]"
                      )).eq(Math.min(e.length - 1, index))).length &&
          ...
          (this.onKeyDown =
            ...
            function (e) {
              ...
              return 8 === e.keyCode &&
                ...
                !this.$activeItems.length &&
                0 <= (index = this.caretPos - 1) &&
                index < this.items.length
                ? ((index = this.options[this.items[index]]),
                  this.deleteSelection(e) &&
                    (this.setTextboxValue(options.text.apply(this, [index])),
                    this.refreshOptions(!0)),
                  void e.preventDefault())
                : original.apply(this, arguments);
            }));
